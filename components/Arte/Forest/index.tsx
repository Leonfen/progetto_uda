...
import styles from './styles/Forest.module.scss';
...
export default function Forest() {
  ...
  useEffect(() => {
    ...
    const zoom = Math.min(3, Math.floor(minWindowSize / (illoSize / 4)) / 5);
  ...
  return (
    <div className={styles.container}>
      <canvas className={styles.illo} id="illo"></canvas>
    </div>
  );
}
